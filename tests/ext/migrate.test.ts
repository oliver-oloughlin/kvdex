...
function createDb(kv: Deno.Kv) {
  return kvdex({
    kv,
    schema: {
      c_TUndefined: collection({ model: model<typeof TUndefined>() }),
      c_TNull: collection({ model: model<typeof TNull>() }),
      c_TNaN: collection({ model: model<typeof TNaN>() }),
      c_TInfinity: collection({ model: model<typeof TInfinity>() }),
      c_TNumber: collection({ model: model<typeof TNumber>() }),
      c_TString: collection({ model: model<typeof TString>() }),
      c_TBigint: collection({ model: model<typeof TBigint>() }),
      c_TKvU64: collection({ model: model<typeof TKvU64>() }),
      c_TBoolean: collection({ model: model<typeof TBoolean>() }),
      c_TInt8Array: collection({ model: model<typeof TInt8Array>() }),
      c_TInt16Array: collection({ model: model<typeof TInt16Array>() }),
      c_TInt32Array: collection({ model: model<typeof TInt32Array>() }),
      c_TBigInt64Array: collection({ model: model<typeof TBigInt64Array>() }),
      c_TUint8Array: collection({ model: model<typeof TUint8Array>() }),
      ...
      c_TDataView: collection({ model: model<typeof TDataView>() }),
      c_TDate: collection({ model: model<typeof TDate>() }),
      c_TError: collection({ model: model<typeof TError>() }),
      c_TRegExp: collection({ model: model<typeof TRegExp>() }),
      c_TArray: collection({ model: model<typeof TArray>() }),
      c_TObject: collection({ model: model<typeof TObject>() }),
      c_TSet: collection({ model: model<typeof TSet>() }),
      c_TMap: collection({ model: model<typeof TMap>() }),
      s_TUndefined: collection({ model: model<typeof TUndefined>() }),
      s_TNull: collection({ model: model<typeof TNull>() }),
      s_TNaN: collection({ model: model<typeof TNaN>() }),
      s_TInfinity: collection({ model: model<typeof TInfinity>() }),
      s_TNumber: collection({ model: model<typeof TNumber>() }),
      s_TString: collection({ model: model<typeof TString>() }),
      s_TBigint: collection({ model: model<typeof TBigint>() }),
      s_TKvU64: collection({ model: model<typeof TKvU64>() }),
      s_TBoolean: collection({ model: model<typeof TBoolean>() }),
      s_TInt8Array: collection({ model: model<typeof TInt8Array>() }),
      s_TInt16Array: collection({ model: model<typeof TInt16Array>() }),
      s_TInt32Array: collection({ model: model<typeof TInt32Array>() }),
      s_TBigInt64Array: collection({ model: model<typeof TBigInt64Array>() }),
      s_TUint8Array: collection({ model: model<typeof TUint8Array>() }),
      ...
      s_TDataView: collection({ model: model<typeof TDataView>() }),
      s_TDate: collection({ model: model<typeof TDate>() }),
      s_TError: collection({ model: model<typeof TError>() }),
      s_TRegExp: collection({ model: model<typeof TRegExp>() }),
      s_TArray: collection({ model: model<typeof TArray>() }),
