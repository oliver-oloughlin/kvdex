...
Deno.test("indexable_collection - deleteManyByOrder", async (t) => {
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        await db.i_users.deleteManyByOrder("age", {
  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        await db.i_multi_part_id_users.deleteManyByOrder("age");
  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        await db.i_users.deleteManyByOrder("username");
  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        await db.i_users.deleteManyByOrder("username", { limit: 2 });
