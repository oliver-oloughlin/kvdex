  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        const docByOldPrimaryIndex = await db.is_users.findBy(
          "username",
          u1.username,
        );

        const docByNewPrimaryIndex = await db.is_users.findBy(
          "username",
          u2.username,
        );
  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        const docByPrimaryIndex = await db.is_users.findBy(
          "username",
          u1.username,
        );
