  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        const { promise, cancel } = db.is_multi_part_id_users.watch(
          id,
          (doc) => {
        ...
        await db.is_multi_part_id_users.set(id, mockUser1);
        await sleep(500);
        await db.is_multi_part_id_users.set(id, mockUser2, { overwrite: true });
        await sleep(500);
        await db.is_multi_part_id_users.update(id, mockUser3);
        await sleep(500);
        await db.is_multi_part_id_users.delete(id);
        await sleep(500);
  ...
  await t.step(
    ...
    async () => {
      await useDb(async (db) => {
        ...
        await db.is_multi_part_id_users.set(id2, mockUser1);
        await sleep(500);
        await db.is_multi_part_id_users.set(id2, mockUser2, {
          overwrite: true,
        });
        await sleep(500);
        await db.is_multi_part_id_users.update(id2, mockUser3);
        await sleep(500);
        await db.is_multi_part_id_users.delete(id2);
        await sleep(500);
